...
export default function Page() {
  const productEntries = [
    {
      title: "Red Lion Type 1",
      image: "/Cement/red lion type 1.png",
      ...
      <div className="mx-auto flex w-full max-w-[90rem] px-4 sm:px-6 pt-6 mb-6 sm:mb-10">
        <Breadcrumb
          items={[
            ...
            { href: "/redLionCement", label: "Red Lion Cement" },
          ]}
        />
      </div>
          ...
          >
            ...
            <div className="lg:w-1/2 space-y-6">
              <div className="space-y-3">
                <h1 className="text-[#eaaa00] text-3xl sm:text-4xl lg:text-6xl font-black leading-tight">
                  {product.title}
                </h1>
