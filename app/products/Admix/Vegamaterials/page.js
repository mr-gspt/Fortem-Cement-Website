      ...
      <div className="mx-auto flex w-full max-w-[90rem] px-4 sm:px-6 pt-6 mb-6 sm:mb-10">
        <Breadcrumb
          items={[
            ...
            { href: "/products/Plywood/TitanPly", label: "Titanply" },
          ]}
        />
      </div>
      <h1 className="text-center items-center justify-center text-5xl text-[#eaaa00]"> Vegamaterial Temporary Placeholder</h1>
          ...
          >
            ...
            <div className="lg:w-1/2 space-y-6">
              <div className="space-y-3">
                <h1 className="text-[#eaaa00] text-3xl sm:text-6xl lg:text-8xl font-black leading-tight">
                  {product.title}
                </h1>
